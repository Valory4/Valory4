            ...
            {isDropdownOpen && (
              <div className="absolute top-full right-0 mt-2 bg-white shadow-md rounded-lg w-48">
                <ul className="text-gray-700">
                  <li className="px-4 py-2 hover:bg-gray-100">Historial de Compras</li>
                  <li className="px-4 py-2 hover:bg-gray-100">Historial de Pagos</li>
                  <li className="px-4 py-2 hover:bg-gray-100">Historial de Contratos</li>
                </ul>
              </div>
            )}
          </div>
